...
const PaginaInicial: React.FC<PaginaInicialProps> = ({ id, onNavigate }) => {
  ...
  '/images/area_de_lazer/piscina_e_jacuzzi.png',
  '/images/ilhas/cozinha_moderna_com_bancadas_e_ilha_em_marmore_calacatta.jpg',
  '/images/bancada/bancadas_funcionais_para_cozinha.png',
  ...
  '/images/bancada/cozinha_moderna_com_bancadas_em_granito.png',
